(function () {
    ...
    describe('Rise.Color', function () {
        ...
        it("Should properly returns true/false for dark/light colors", function () {
            new Rise.Color('#000').isDark().should.be.equal(true);
            new Rise.Color('#111').isDark().should.be.equal(true);
            new Rise.Color('#222').isDark().should.be.equal(true);
            new Rise.Color('#333').isDark().should.be.equal(true);
            new Rise.Color('#444').isDark().should.be.equal(true);
            new Rise.Color('#555').isDark().should.be.equal(true);
            new Rise.Color('#666').isDark().should.be.equal(true);
            new Rise.Color('#777').isDark().should.be.equal(true);
            new Rise.Color('#888').isDark().should.be.equal(false);
            new Rise.Color('#999').isDark().should.be.equal(false);
            new Rise.Color('#aaa').isDark().should.be.equal(false);
            new Rise.Color('#bbb').isDark().should.be.equal(false);
            new Rise.Color('#ccc').isDark().should.be.equal(false);
            new Rise.Color('#ddd').isDark().should.be.equal(false);
            new Rise.Color('#eee').isDark().should.be.equal(false);
            new Rise.Color('#fff').isDark().should.be.equal(false);
        });

        it("Should properly returns true/false for light/dark colors", function () {
            new Rise.Color('#000').isLight().should.be.equal(false);
            new Rise.Color('#111').isLight().should.be.equal(false);
            new Rise.Color('#222').isLight().should.be.equal(false);
            new Rise.Color('#333').isLight().should.be.equal(false);
            new Rise.Color('#444').isLight().should.be.equal(false);
            new Rise.Color('#555').isLight().should.be.equal(false);
            new Rise.Color('#666').isLight().should.be.equal(false);
            new Rise.Color('#777').isLight().should.be.equal(false);
            new Rise.Color('#888').isLight().should.be.equal(true);
            new Rise.Color('#999').isLight().should.be.equal(true);
            new Rise.Color('#aaa').isLight().should.be.equal(true);
            new Rise.Color('#bbb').isLight().should.be.equal(true);
            new Rise.Color('#ccc').isLight().should.be.equal(true);
            new Rise.Color('#ddd').isLight().should.be.equal(true);
            new Rise.Color('#eee').isLight().should.be.equal(true);
            new Rise.Color('#fff').isLight().should.be.equal(true);
        });
        ...
        it("Should properly return string", function () {
            ...
            color.toString("name").should.be.equal(false);
        ...
        it("Should properly spin color", function () {
            expect(Math.round(new Rise.Color("#f00").spin(-1234).toHsl().h)).be.equal(206);
            expect(Math.round(new Rise.Color("#f00").spin(-360).toHsl().h)).be.equal(0);
            expect(Math.round(new Rise.Color("#f00").spin(-120).toHsl().h)).be.equal(240);
            expect(Math.round(new Rise.Color("#f00").spin(0).toHsl().h)).be.equal(0);
            expect(Math.round(new Rise.Color("#f00").spin(10).toHsl().h)).be.equal(10);
            expect(Math.round(new Rise.Color("#f00").spin(360).toHsl().h)).be.equal(0);
            expect(Math.round(new Rise.Color("#f00").spin(2345).toHsl().h)).be.equal(185);
        });
        ...
        it("Should properly check for equals colors", function () {
            Rise.Color.equals("#ff0000", "#ff0000").should.be.equal(true);
            Rise.Color.equals("#ff0000", "rgb(255, 0, 0)").should.be.equal(true);
            Rise.Color.equals("ff0000", "#ff0000").should.be.equal(true);
            Rise.Color.equals("#f00", "#ff0000").should.be.equal(true);
            Rise.Color.equals("f00", "#ff0000").should.be.equal(true);
            Rise.Color.equals("#ff8000", "rgb(100%, 50%, 0%)").should.be.equal(true);

            colorConversions.forEach(function (color) {
                Rise.Color.equals(color.rgb, color.hex).should.be.equal(true);
                Rise.Color.equals(color.rgb, color.hex8).should.be.equal(true);
                Rise.Color.equals(color.rgb, color.hsl).should.be.equal(true);
                Rise.Color.equals(color.rgb, color.hsv).should.be.equal(true);
                Rise.Color.equals(color.rgb, color.rgb).should.be.equal(true);
                Rise.Color.equals(color.hex, color.hex).should.be.equal(true);
                Rise.Color.equals(color.hex, color.hex8).should.be.equal(true);
                Rise.Color.equals(color.hex, color.hsl).should.be.equal(true);
                Rise.Color.equals(color.hex, color.hsv).should.be.equal(true);
                Rise.Color.equals(color.hsl, color.hsv).should.be.equal(true);
            });
        });
        ...
        it("Should properly mix colors", function () {
            ...
            for (var i = 0; i < 100; i++) {
                expect(Math.round(Rise.Color.mix('#000', '#fff', i).toHsl().l * 100) / 100).be.equal(i / 100);
